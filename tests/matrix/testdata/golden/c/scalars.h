...
#ifndef MESSAGES_SCALARS_H
#define MESSAGES_SCALARS_H
...
#define MESSAGES_SCALARS_MAX_SIZE 49
...
/*! Decode buf[len] into msg (call messages_scalars_init first to apply defaults). Returns sofab_ret_t. */
sofab_ret_t messages_scalars_decode(messages_Scalars_t *msg, const uint8_t *buf, size_t len);

#endif /* MESSAGES_SCALARS_H */
