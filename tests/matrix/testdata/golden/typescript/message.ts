...
export class Scalars {
  ...
  static decodeFrom(c: Cursor): Scalars {
    ...
    while (c.readHeader()) {
      switch (c.id) {
      case 0: o.u8min = Number(c.readUnsigned()); break;
      case 1: o.u8max = Number(c.readUnsigned()); break;
      case 2: o.u64max = c.readUnsigned() as bigint; break;
      case 3: o.i8min = Number(c.readSigned()); break;
      case 4: o.i64min = c.readSigned() as bigint; break;
      case 5: o.f32 = c.readFp32(); break;
      case 6: o.f64 = c.readFp64(); break;
      case 7: o.flag = Boolean(c.readUnsigned()); break;
