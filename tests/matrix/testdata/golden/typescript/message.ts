...
import { OStream, FixlenSubtype, ArrayKind, DecodeStatus, SofabError, SofabErrorCode, Visitor, ArrayTarget, BoolArrayTarget, IStream, PayloadAcc, decode as _decode } from "@sofa-buffers/corelib";
...
export class Scalars {
  ...
  isDefault(): boolean {
    ...
    if (!(this.flags.length === 0)) return false;
    return true;
  }
  ...
  toJSON(): Record<string, unknown> {
    return {
      ...
      "f64": this.f64,
      "flag": this.flag,
      "flags": Array.from(this.flags, (_x0) => _x0 !== 0),
    };
  }
