...
// over the generated module, a package.json depending on @sofabuffers/corelib,
...
const packageJSON = `{
  ...
  "private": true,
  "type": "module",
  "dependencies": { "@sofabuffers/corelib": "*" },
...
const readme = "# Generated SofaBuffers TypeScript module\n\n" +
	"`@generated by sofabgen`. Encode/decode harness over `@sofabuffers/corelib`.\n\n" +
	"```sh\nnpm install\n" +
