...
// harness over corelib-rs-no-std (built with std + the required features).
...
const rustReadme = "# Generated SofaBuffers Rust crate\n\n" +
	"`@generated by sofabgen`. Encode/decode harness over `corelib-rs-no-std`.\n\n" +
...
[dependencies]
sofab = { path = "${SOFAB_RS_CORELIB}"` + feats + ` }
