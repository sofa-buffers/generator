...
func (g *gen) makefile() string {
	return `# @generated by sbufgen — builds the encode/decode harness against corelib-c-cpp.
...
const devcontainer = `{
  "// @generated by sbufgen": "reuses corelib-c-cpp's toolchain (Ubuntu 24.04 + gcc + cmake)",
...
# @generated by sbufgen — build + a JSON encode->decode round-trip smoke test.
set -eu
...
func (g *gen) readme(s *ir.Schema) string {
	...
	b.WriteString("`@generated by sbufgen`. Builds an encode/decode harness against `corelib-c-cpp`.\n\n")
